...
export default function DownloadsPage() {
  return (
    <div className="bg-[#FAF8F4] min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pt-16 lg:pt-20 pb-10">
        ...
        <div className="mt-6 max-w-2xl space-y-4 text-[#262B3D] text-lg leading-relaxed">
          <p>
            ...
            used. <span className="text-[#1A1B2E]">There are no versions to fall
          ...
          <p>
            ...
            <span className="text-[#1A1B2E]">&ldquo;Do I want that?&rdquo;</span>{" "}
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pb-14 border-t border-[rgba(26,27,46,0.13)] pt-14">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pb-20 border-t border-[rgba(26,27,46,0.13)] pt-14">
        ...
        <div className="max-w-2xl space-y-4 text-[#262B3D] text-lg leading-relaxed">
          <p>
            ...
            <span className="text-[#1A1B2E]"> Your AI builds the capability to fit
          ...
          <p>
            ...
            <span className="text-[#1A1B2E]"> Nothing you built gets replaced
            ...
            <span className="text-[#1A1B2E]">&ldquo;Show me in plain words what you
          ...
          <p className="text-[#262B3D]/70 text-base">
