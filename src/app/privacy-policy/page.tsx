            ...
            <section className="pt-24 pb-16 bg-[#FAF8F4]">
                <div className="container mx-auto">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="text-[#1A1B2E] text-4xl font-bold tracking-tight mb-6">Privacy Policy</h1>
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Introduction</h2>
                            ...
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Information We Collect</h2>
                                <p className="text-[#262B3D] mb-4">
                            ...
                            <div className="bg-[#FFFFFF] border-2 border-[#2B5D96] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4 text-[#2B5D96]">SMS/Text Messaging Terms</h2>
                                <p className="text-[#262B3D] mb-4">
                                    By providing your phone number and opting in to receive SMS messages from Kerzie AI, you agree to the following:
                                </p>
                                <ul className="list-disc pl-6 space-y-3 text-[#262B3D] mb-6">
                                    <li>
                                ...
                                <div className="bg-[#F2EEE6] rounded-lg p-4">
                                    <p className="text-sm text-[#262B3D]">
                            ...
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">How We Use Your Information</h2>
                                <p className="text-[#262B3D] mb-4">
                            ...
                            {/* Information Sharing */}
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Information Sharing and Disclosure</h2>
                                <p className="text-[#262B3D] mb-4">
                            ...
                            {/* Data Security */}
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Data Security</h2>
                                <p className="text-[#262B3D]">
                            ...
                            {/* Your Rights */}
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Your Rights</h2>
                                <p className="text-[#262B3D] mb-4">
                            ...
                            {/* Contact Information */}
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Contact Us</h2>
                                <p className="text-[#262B3D] mb-4">
                            ...
                            {/* Changes to Policy */}
                            <div className="bg-[#FFFFFF] border border-[rgba(26,27,46,0.13)] p-8 mb-8">
                                <h2 className="text-[#1A1B2E] text-xl font-semibold mb-4">Changes to This Privacy Policy</h2>
                                <p className="text-[#262B3D]">
