    ...
    <div className="bg-[#FAF8F4] min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 py-14 border-t border-[rgba(26,27,46,0.13)]">
        <Reveal>
          ...
          <video
            ...
            className="w-full max-w-3xl rounded-lg border border-[rgba(26,27,46,0.13)] shadow-2xl shadow-black/40"
          >
        ...
        <Reveal>
          ...
          <div className="max-w-2xl space-y-4 text-[#262B3D] text-lg leading-relaxed">
            ...
            <p>
              ...
              <span className="text-[#1A1B2E] font-medium">Traffic.</span>{" "}
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 py-14 border-t border-[rgba(26,27,46,0.13)]">
        <Reveal>
          ...
          <p className="max-w-2xl mt-12 text-[#262B3D] text-lg leading-relaxed">
          ...
          <div className="max-w-2xl mt-12 border-l-2 border-[#B04E2B] pl-6 py-1">
            <p className="text-[#1A1B2E] text-lg font-medium leading-relaxed mb-4">
              We only add. We never break anything.
            </p>
            <div className="space-y-4 text-[#262B3D] text-lg leading-relaxed">
              <p>
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 py-14 border-t border-[rgba(26,27,46,0.13)]">
        <Reveal>
          ...
          <p className="max-w-2xl mt-8 text-[#262B3D] text-lg leading-relaxed">
            <span className="text-[#1A1B2E] font-medium">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 py-16 border-t border-[rgba(26,27,46,0.13)]">
        <Reveal>
          ...
          <p className="max-w-2xl mt-8 text-[#262B3D] text-lg leading-relaxed">
            ...
            the year at{" "}
            <span className="text-[#1A1B2E] font-medium">$990</span> and get two
            months back.
          </p>
          {/* Refresh tiers decided on the Wade/Aaron call 8/14 ($99 twice-
              monthly / $299 daily). Daily tier repriced $299 -> $999/mo per
              rooftop on the 8/27 Shortline call with Danny - agreed on the
              call, published within the hour per Wade's commitment. */}
          <p className="max-w-2xl mt-6 text-[#262B3D] text-lg leading-relaxed">
