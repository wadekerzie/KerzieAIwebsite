  ...
  return (
    <div className="bg-[#1A1B2E] min-h-screen">
      <div className="max-w-4xl mx-auto px-6 pt-12 pb-20">
        <p className="k-mono text-[#AABBCC]/70 text-xs tracking-[0.15em]">
          KERZIE<span className="text-[#E8896A]">.</span>AI &middot; PARTNER
          VIEW
        </p>
        <h1 className="text-white font-bold tracking-[-0.02em] text-[clamp(2rem,5vw,3rem)] mt-6">
          Danny&apos;s pipeline<span className="text-[#E8896A]">.</span>
        </h1>
        <p className="text-[#AABBCC] text-lg mt-4 max-w-2xl leading-relaxed">
          Every rooftop you bring in, from intro to paying - and every dollar
          on its way to you. Updated {pipeline.updated}.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10">
          <div className="border border-[rgba(170,187,204,0.2)] rounded p-5">
            <p className="k-mono text-[#6B9FD4] text-xs tracking-[0.15em]">
              ROOFTOPS PAYING
            </p>
            <p className="text-white text-4xl font-bold mt-2">{paying}</p>
          </div>
          <div className="border border-[rgba(170,187,204,0.2)] rounded p-5">
            <p className="k-mono text-[#6B9FD4] text-xs tracking-[0.15em]">
          ...
          <div className="border border-[rgba(170,187,204,0.2)] rounded p-5">
            ...
            <p className="text-white text-4xl font-bold mt-2">$300/mo</p>
          </div>
        </div>

        <h2 className="k-mono text-[#E8896A] text-xs tracking-[0.15em] mt-14 mb-4">
          THE PIPELINE
        </h2>
        {leads.length === 0 ? (
          <p className="text-[#AABBCC] text-lg leading-relaxed border border-dashed border-[rgba(170,187,204,0.25)] rounded p-6">
            Your first intros land here the moment they happen - rooftop name,
            stage, and what is next. Stages: {pipeline.stages.join(" → ")}.
          </p>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[#AABBCC]">
              <thead className="k-mono text-xs tracking-[0.1em] text-[#6B9FD4]">
                <tr>
              ...
              <tbody>
                {leads.map((l) => (
                  <tr
                    key={l.rooftop}
                    className="border-t border-[rgba(170,187,204,0.13)]"
                  >
                    <td className="py-3 pr-6 text-white">{l.rooftop}</td>
              ...
              <tbody>
                {payments.map((p, i) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-6 text-white">{p.rooftop}</td>
        ...
        <div className="mt-14 border-t border-[rgba(170,187,204,0.13)] pt-6 text-[#AABBCC]/80 text-base leading-relaxed max-w-2xl">
          <p>
