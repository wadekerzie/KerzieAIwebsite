...
// The dismissible QR overlay on /card/jordan. This is Wade's ../QrPanel.tsx
// with Jordan's code and name - read THAT file before changing this one: it
...
export default function QrPanel({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Jordan Holzmiller contact QR code"
      onClick={onClose}
