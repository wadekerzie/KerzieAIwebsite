...
// /card/jordan by SCANNING the code and needs "Save my contact"; Jordan arrives
...
// screen before Jordan has finished turning the phone around. The site header
...
export const metadata: Metadata = {
  title: "My QR | Jordan Holzmiller",
  description: "Jordan Holzmiller's contact QR code.",
  // Jordan's own utility surface. Keep it out of the index - /card/jordan is
...
export default function JordanShowQrPage() {
  return (
    ...
    >
      ...
      <img
        src="/jordan-card-qr.svg"
        alt="QR code linking to Jordan Holzmiller's contact card"
