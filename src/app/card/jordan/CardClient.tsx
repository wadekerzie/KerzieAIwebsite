...
// commentary): a stranger who scanned Jordan's QR needs "Save my contact"
// loudest; Jordan's own fast path is /card/jordan/show, the icon on HIS home
// screen. The button below is the fallback for when he is already here.

const ACTIONS = [
  {
    href: "/api/vcard/jordan",
    label: "Save my contact",
    sub: "Adds Jordan to your phone",
    primary: true,
  },
  {
    href: "https://jordanholzmiller.vercel.app/",
    label: "Visit jordanholzmiller.vercel.app",
    sub: "Projects and background",
    primary: false,
  },
  {
    href: "tel:+12148621505",
    label: "Call 214-862-1505",
    sub: null,
    primary: false,
  },
  {
    href: "mailto:jordan@kerzie.ai",
    label: "jordan@kerzie.ai",
    sub: null,
    primary: false,
  },
];
  ...
  return (
    <>
      ...
      <div className="mx-auto flex w-full max-w-md flex-col items-center px-6 pb-16 pt-10">
        ...
        <p className="mt-1 text-[#262B3D]">Account Executive, Kerzie AI Solutions</p>
        <p className="mt-1 text-sm text-[#5B6B77]">Dallas, Texas</p>
