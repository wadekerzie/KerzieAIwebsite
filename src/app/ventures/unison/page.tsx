...
export default function UnisonVenture() {
  return (
    <>
      {/* Hero Section */}
      <section className="section-hero section-cream">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Trust Indicators */}
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-[var(--foreground-muted)] animate-fade-in delay-500">
      ...
      {/* Video Section */}
      <section className="section-compact" style={{ background: '#ffffff' }}>
        <div className="container mx-auto">
      ...
      <section className="section section-cream">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/how-it-works" className="btn-primary btn-lg">
              <span>
      ...
      {/* Why We're Different */}
      <section className="section-compact section-accent">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
