    ...
    <div className="bg-[#FAF8F4] min-h-screen">
      <div className="max-w-4xl mx-auto px-6 pt-10 pb-20">
        ...
        <h1 className="text-[#1A1B2E] font-bold tracking-[-0.025em] leading-[1.05] text-[clamp(1.75rem,4.5vw,2.5rem)]">
          {preview.dealer}<span className="text-[#B04E2B]">.</span>
        </h1>
        ...
        <div className="mt-8 rounded-lg border border-[rgba(26,27,46,0.2)] bg-[rgba(26,27,46,0.06)] px-5 py-4">
          ...
          <p className="mt-3 text-[#262B3D] leading-relaxed">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-lg border border-[rgba(26,27,46,0.2)] px-5 py-4">
            <p className="k-mono text-[#2B5D96] text-[10px] tracking-[0.15em]">
              VEHICLES
            </p>
            <p className="mt-2 text-[#1A1B2E] text-2xl font-medium">
              {preview.vehicles}
            </p>
            <p className="mt-1 text-[#262B3D]/70 text-sm">
              Price on every one
            </p>
          </div>
          <div className="rounded-lg border border-[rgba(26,27,46,0.2)] px-5 py-4">
            ...
            <p className="mt-2 text-[#1A1B2E] text-2xl font-medium">Aug 20</p>
            <p className="mt-1 text-[#262B3D]/70 text-sm">From your live site</p>
          </div>
          <div className="rounded-lg border border-[rgba(26,27,46,0.2)] px-5 py-4">
            <p className="k-mono text-[#2B5D96] text-[10px] tracking-[0.15em]">
              REFRESH
            </p>
            <p className="mt-2 text-[#1A1B2E] text-2xl font-medium">Daily</p>
            <p className="mt-1 text-[#262B3D]/70 text-sm">Once you are live</p>
          </div>
        </div>

        <p className="mt-8 text-[#262B3D] leading-relaxed">
        ...
        <div className="rounded-lg border border-[rgba(26,27,46,0.2)] bg-[rgba(0,0,0,0.25)] max-h-[36rem] overflow-auto">
          <pre className="k-mono text-[#262B3D] text-xs leading-relaxed p-5 whitespace-pre-wrap break-words">
            {preview.content}
          </pre>
        </div>
